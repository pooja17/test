...
$config['nav']['household'] = array(
          ...
          'village' => 'List of Villages');

$config['nav']['ocop'] = array(
          'information_child' => 'Summary Of Questionnaire',
          ...
          'welfare' => 'Welfare',
          'mother_data' => 'Data of Mother',
          'father_data' => 'Data Of Father',
          'guardian_data' => 'Data of Guardian');

$config['nav']['DRQ'] = array(
          'drq_information_child' => 'Summary Of Questionnaire',
          'drq_birth_death_info' => 'Still Birth/Death Info',
          'drq_general_info' => "Child's General Death Info",
          'drq_immunization' => 'Immunization',
        'drq_preg_mother_data'  => 'Pregnancy Period Dead Info',
           'drq_mother_data' => "Mother's General Death Info",
          'drq_father_data' => "Father's Death Details");
...
$config['nav']['OCOP_Reports'] = array(
          ...
          'childcurrent_report' => 'Childrens Current Details',
